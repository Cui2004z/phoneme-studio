...
@media(max-width:420px){.activity{padding:20px 13px}.key-row{grid-template-columns:repeat(8,1fr)}.sound-key{min-height:40px}.sound-key small{font-size:12px}.search-board{gap:3px}.search-cell{font-size:17px}.search-words{gap:5px}.search-words li{padding:5px 7px}.legend{gap:8px}h1{font-size:23px}}
